...
router.post('/user/send-forgot-otp',authenticateToken,async (req:Request,res:Response)=>{
...
router.post('/user/reset-password',authenticateToken,async (req:Request,res:Response)=>{
